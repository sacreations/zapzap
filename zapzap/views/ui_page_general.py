...
class Ui_PageGeneral(object):
    def setupUi(self, PageGeneral):
        ...
        self.btn_native_context_menu = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.btn_native_context_menu.setObjectName("btn_native_context_menu")
        self.verticalLayout.addWidget(self.btn_native_context_menu)
    ...
    def retranslateUi(self, PageGeneral):
        ...
        self.btn_native_context_menu.setText(_("Use Native WhatsApp Context Menu"))
